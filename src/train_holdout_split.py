...
'''
data_path = '../data/gen12'
folder_ls = ["train/*", "val/*", "test/*"]
def split():
    split_folders.ratio('../data/gen12/fulldata', output="../data/gen12", seed=1337, ratio=(.64, .16, .2)) #code labels train/test/holdout folders as train/val/test
